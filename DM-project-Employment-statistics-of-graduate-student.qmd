...
Here, we get the panel data "insertion_master_panel" by joining the wage data from the complementary dataset to our main dataset.
...
Additionally, in the "Académie" column, there are N/A values. We have removed these irrelevant entries from our main dataset.
...
And to facilitate our future analysis, we convert some character-formatted data values into numeric format.
...
Here are "summary" observations in our data set : 
