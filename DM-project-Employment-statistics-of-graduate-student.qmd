...
aggregate_femme |> ggplot(aes(x=`Taux de femmes`, y= Discipline)) + geom_point() 
...
#'[Formatting]
aggregate_scholarship |> knitr::kable(caption = "Percentage of graduates with a scholarship per specialization") |> row_spec(c(13, 14, 15), background = "yellow")
```
