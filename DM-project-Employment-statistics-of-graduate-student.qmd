...
```{r}
## The columns '% femmes' and '% de diplômés boursiers' have to be converted into numerical values. 
aggregate_data[, c(22, 27)] <- sapply(aggregate_data[, c(22,27)], function(x){
  if (is.character(x)){
    as.numeric(ifelse(is.na(x), NA, x))
  } else {
    x
