...
### Question 5: Do some specializations require to leave the region of the “académie” where the master’s degree was done?
...
insertion_master_panel |>
  ...
  arrange(desc(`%_ext`)) |>
  knitr::kable(digits = 3, align = "c",
               caption = "Specializations with the highest rate of graduates working outside of their region of graduation",
...
insertion_master_panel |>
  ...
  slice(which.min(`%_ext`)) |>
    arrange(desc(`%_ext`)) |>
  knitr::kable(digits = 3, align = "c",
               caption = "Specializations with the lowest rate of graduates working outside of their region of graduation",
               col.names = c("Académie", "Field", "% working outside their region of graduation"))
