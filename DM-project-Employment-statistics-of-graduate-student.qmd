...
kable(merged_domain_stats, caption = "Optimal Employment Perfomance by Domain", align = 'c')
```
...
kable(best_domain_mean, caption = "Average Employment Perfomance by Domain", align = 'c', digits = 2)
...
kable(best_specializations_mean, caption = "Average Employment Perfomance by Specializations", align = 'c', digits = 2)
```
...
kable(merged_table, align = "c", caption = "Average Salaries of Law, Economics, and Management Graduates: 30 Months After Graduation")
```
