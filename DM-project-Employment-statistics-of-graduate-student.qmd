...
top_5 <- best_specializations_mean[1:5, ]
bottom_5 <- best_specializations_mean[(nrow(best_specializations_mean)-4):nrow(best_specializations_mean),]
...
merged_table <- top_5 |>
  ...
  mutate(MeanSalaire = as.character(MeanSalaire),
         MeanInsertionRate = as.character(MeanInsertionRate),
         MeanStableEmployment = as.character(MeanStableEmployment)) |>
  mutate(MeanSalaire = if_else(MeanSalaire == "NA", "...", MeanSalaire),
         MeanInsertionRate = if_else(MeanInsertionRate == "NA", "...", MeanInsertionRate),
         MeanStableEmployment = if_else(MeanStableEmployment == "NA", "...", MeanStableEmployment))
