...
$$ Where:<br> - $Y_i$: Estimated annual salaries.<br> - $D_{University_j}$: Dummy variables for universities.<br> - $D_{Major_k}$: Dummy variables for fields.<br> - $D_{City_l}$: Dummy variables for cities.<br> - $Duration$: Graduation duration (18 or 30 months).<br>
