...
aggregate_femme |> filter(`Taux de femmes` > average_femme) |> arrange(desc(`Taux de femmes`) ) |> mutate(nb_of_sd = round((`Taux de femmes` - average_femme)/stdev_femme,4)) |> knitr::kable()
